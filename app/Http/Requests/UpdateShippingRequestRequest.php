...
class UpdateShippingRequestRequest extends FormRequest
{
    ...
    {
        return [
            'request_code' => ['sometimes', 'required', 'string', 'max:255'],
            ...
            'driver_phone' => ['sometimes', 'required', 'string', 'max:255'],
            'seal_number' => ['nullable', 'string', 'max:255'],
            'priority' => ['sometimes', 'required', 'integer', 'min:1', 'max:5'],
            'notes' => ['nullable', 'string'],
            'items' => ['sometimes', 'required', 'array', 'min:1'],
            'items.*.id' => ['sometimes', 'required', 'exists:shipping_request_items,id'],
